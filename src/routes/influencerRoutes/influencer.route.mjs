...
import {
  approveRejectInfluencer,
  deleteInfluencer,
  getAllInfluencerRequest,
  getSingleIncluencer,
  MultipleInfluencerDelete,
  requestInfluencer,
} from "../../controllers/influencerController/influencerController.mjs";
import {
  accessMiddleware,
  AuthMiddleware,
...
import {
  ...
  influencerSchema,
  StatusSchema,
  multipleInfluencerDeleteSchema,
...
influencerRouter.post(
  ...
  validateRequest(influencerSchema),
  requestInfluencer,
);
...
influencerRouter.delete(
  ...
  AuthMiddleware,
  accessMiddleware("admin"),
  validateRequest(multipleInfluencerDeleteSchema),
  MultipleInfluencerDelete,
);
